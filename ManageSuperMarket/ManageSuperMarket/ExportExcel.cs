...
namespace ManageSuperMarket
{
    class ExportExcel
    {
        public static string duongdanex = Application.CommonAppDataPath;
        ...
        public static void ExportBill(DataGridView g, string duongdan, string tenfile, string s, string tile, string chietkhau)
        {
            duongdan = duongdanex;
            app obj = new app();
            obj.Application.Workbooks.Add(Type.Missing);
